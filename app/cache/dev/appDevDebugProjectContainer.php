...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'blogSpa', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\BlogSpa\\UserBundle\\Entity'))), 'BlogSpa\\UserBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('BlogSpaUserBundle' => 'BlogSpa\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_effa13142c8d3378a4e48147747b12cd8af9818988e8f05887b362f2a166ce72');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\BlogSpa\\GeneralBundle/Resources/views'), 'BlogSpaGeneral');
        $instance->addPath(($this->targetDirs[3].'\\src\\BlogSpa\\UserBundle/Resources/views'), 'BlogSpaUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5996d6b55c5a3473a057ee7e32892f032014a4ff');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BlogSpaGeneralBundle' => 'BlogSpa\\GeneralBundle\\BlogSpaGeneralBundle',
                'BlogSpaUserBundle' => 'BlogSpa\\UserBundle\\BlogSpaUserBundle',
            ...
            'secret' => '5996d6b55c5a3473a057ee7e32892f032014a4ff',
            'locale' => 'en',
            ...
            'kernel.secret' => '5996d6b55c5a3473a057ee7e32892f032014a4ff',
